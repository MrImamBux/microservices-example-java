...
java -Dspring.profiles.active=$PROFILE \
     ...
     -Dspring.cloud.stream.bindings.kafka.binder.zkNodes=$ZOOKEEPER_URI \
     -Dspring.cloud.stream.bindings.kafka.binder.brokers=$KAFKA_URI \
     -Dspring.cloud.stream.kafka.binder.brokers=$KAFKA_URI \
     -jar /usr/local/organization-service/@ARTIFACT@